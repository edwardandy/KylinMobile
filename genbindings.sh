...
NDK_ROOT="/Users/chenyonghua/workspace/android-ndk-r9"
COCOS2DX_ROOT="/Users/chenyonghua/workspace/cocos2d-x/cocos2d-x-2.2.1"
...
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${COCOS2DX_ROOT}/projects/Training/cocos2dx_smartfish.ini -s smartfish -o ${COCOS2DX_ROOT}/projects/Training/scripting/generated -n jsb_smartfish_extension_auto
